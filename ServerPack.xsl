...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:x="http://www.mcupdater.com"
	...
	<xsl:template match="/">
		<html lang="en-US">
			<head>
				<link href="https://code.jquery.com/ui/1.11.2/themes/vader/jquery-ui.min.css" rel="stylesheet" type="text/css" />
				<!--[if lt IE 9]>
					...
					<div class="content-wrapper">
						<div class="ui-accordion ui-widget">
							...
							<div class="mcupdater ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom">
								Created using <a href="https://www.mcupdater.com">MCUpdater</a> ServerPack version <xsl:value-of select="x:ServerPack/@version"/>
							</div>
